	...
	return (
		<div className="sticky shrink flex top-0 w-full border-b border-zinc-300 dark:border-zinc-800 p-2 gap-x-2 z-50">
			<button
				...
				className={`flex content-center px-2 text-sm duration-300 border rounded hover:shadow-md focus:ring-2 ${selectedRuntime
					? isRunning
			...
			{isRunning ? (
				<>
					<Tooltip text={isPaused ? "Resume" : "Pause"}>
						<button
							className={`flex content-center text-sm duration-300 border rounded hover:shadow-md focus:ring-2 ${isPaused
								? "bg-green-500/10 hover:bg-green-500/20 border-green-700 dark:border-green-300 text-green-700 dark:text-green-300 hover:shadow-green-500 ring-green-500"
			...
			>
				<button
					type="button"
					className={`flex px-2 py-0.5 content-center border border-zinc-500 rounded hover:bg-zinc-500/20 focus:ring-zinc-500 focus:ring-2 duration-300 ${selectedRuntime
						? ""
